...
{
    [Export(typeof(CRONGeneratorToolViewModel))]
    public sealed class CRONGeneratorToolViewModel : ObservableRecipient, IToolViewModel
    {
        /// <summary>
        ...
        private static readonly SettingDefinition<bool> Uppercase
            = new(
                name: $"{nameof(CRONGeneratorToolViewModel)}.{nameof(Uppercase)}",
                isRoaming: true,
                defaultValue: false);
        ...
        private static readonly SettingDefinition<bool> Hyphens
            = new(
                name: $"{nameof(CRONGeneratorToolViewModel)}.{nameof(Hyphens)}",
                isRoaming: true,
                defaultValue: true);
        ...
        private static readonly SettingDefinition<string> Version
            = new(
                name: $"{nameof(CRONGeneratorToolViewModel)}.{nameof(Version)}",
                isRoaming: true,
        ...
        private static readonly SettingDefinition<int> GuidsToGenerate
            = new(
                name: $"{nameof(CRONGeneratorToolViewModel)}.{nameof(GuidsToGenerate)}",
                isRoaming: true,
                defaultValue: 1);
        ...
        public CRONGeneratorToolViewModel(ISettingsProvider settingsProvider, IMarketingService marketingService)
        {
