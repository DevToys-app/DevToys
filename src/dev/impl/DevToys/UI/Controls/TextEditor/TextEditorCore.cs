...
namespace DevToys.UI.Controls.TextEditor
{
    ...
    public sealed class TextEditorCore : RichEditBox
    {
        ...
        private void ApplySettings()
        {
            ...
            {
                FontFamily = new FontFamily(settingsProvider.GetSetting(PredefinedSettings.TextEditorFont));
        ...
        private async Task PastePlainTextFromWindowsClipboardAsync(TextControlPasteEventArgs? args)
        {
            ...
            {
                Logger.LogFault("Failed to paste in text editor core", ex);
            }
        }
