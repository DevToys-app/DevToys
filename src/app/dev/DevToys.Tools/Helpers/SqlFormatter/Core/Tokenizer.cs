...
internal class Tokenizer
{
    ...
    internal IReadOnlyList<Token> Tokenize(string input)
    {
        ...
        while (pointerIndex != input.Length)
        {
            ...
            int precedingWhitespaceLength = GetPrecedingWhitespaceLength(input, pointerIndex);

            pointerIndex += precedingWhitespaceLength;
            ...
            if (pointerIndex != input.Length)
            {
                ...
                if (token is not null)
                {
                    ...
                    t.PrecedingWitespaceLength = precedingWhitespaceLength;
                    tokens.Add(t);
                }
            }
        }
    ...
    private static int GetPrecedingWhitespaceLength(string input, int pointerIndex)
    {
        int i = 0;
