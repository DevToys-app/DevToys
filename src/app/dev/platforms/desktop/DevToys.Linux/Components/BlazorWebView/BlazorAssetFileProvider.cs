...
/// <summary>
/// A minimal implementation of an <see cref="IFileProvider"/> to be used by the <see cref="BlazorWebView"/> and <see cref="BlazorWebViewBridge"/> types.
/// </summary>
internal sealed class BlazorAssetFileProvider : IFileProvider
{
    ...
    {
        _bundleRootDir = Path.Combine(Path.GetDirectoryName(Assembly.GetEntryAssembly()!.Location)!, contentRootDir);
    }
